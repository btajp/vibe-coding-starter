...
### 1. [コンテキストウィンドウを理解する](01-context-window-basics.md)

AIが一度に扱える文脈には上限があることを確認します。

### 2. [AIに質問役を頼む](02-ask-ai-to-question-you.md)

人間が最初から要件を全部書くのではなく、AIに質問してもらい、回答しながら要件を固めます。

### 3. [要件メモを正本にする](03-requirements-note-source-of-truth.md)
...
### 5. [補助コンテキストを使う](05-use-supporting-context.md)

公式ドキュメント、設計メモ、OSSリポジトリなどを、作業対象とは別の参照情報として扱います。

### 6. [第3部の確認](06-review-context-window-notes.md)
