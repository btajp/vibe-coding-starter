...
### 2. [AIが働く環境を分解する](02-ai-work-environment-parts.md)

AGENTS.md、要件メモ、補助コンテキスト、プロンプトテンプレート、skills、確認コマンドなどの役割を分けます。

### 3. [見せる情報と見せない情報を決める](03-ai-context-allow-deny.md)

AIに見せると助けになる情報と、見せてはいけない秘密情報を分けます。

### 4. [変更前後で確認できる形にする](04-verify-before-after.md)

`git status`、`git diff`、build、test、lintなど、AIの作業を受け止める確認手順を整理します。

### 5. [第1部の確認](05-review-ai-work-environment.md)
