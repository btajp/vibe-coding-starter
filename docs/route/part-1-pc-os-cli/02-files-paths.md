...
`site/sidebars.js` は、Docusaurusのサイドバー構成を定義しているファイルです。
...
成果物リポジトリは、あとで自分が作るポートフォリオ用のリポジトリです。

```text
~/src/github.com/あなたのGitHubユーザー名/my-vibe-coding-portfolio
```

この2つを混同すると、AIに教材を編集させてしまったり、自分の成果物を別の場所に作ってしまったりします。

AIに頼む前に、必ず今いる場所を確認します。
...
たとえば、教材リポジトリでAIを起動したつもりが、成果物リポジトリにいた場合、AIは成果物側のファイルを見ます。
逆に、成果物を編集したいのに教材リポジトリにいると、AIへの依頼がうまく伝わりません。
...
AIに確認を頼む場合も、ファイル変更を許可しない限りcommitは不要です。
