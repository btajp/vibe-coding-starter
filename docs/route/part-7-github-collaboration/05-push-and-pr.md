...
![自分のforkへpushし、元リポジトリへPull Requestを作る流れ](../../images/route-github-collaboration/push-pr-direction.png)
...
AIに、push、Pull Request、送信前確認のどれに当たるかを見分ける問題を出してもらいます。

```text
GitHubでpushとPull Requestの流れを見分ける練習問題を出してください。

次の条件でお願いします。

- 問題は5問
- 各問題は、A/B/Cから選ぶ選択式にする
- 選択肢は、A: push、B: Pull Request、C: 送信前確認、にする
- 一問一答形式にする
