...
各部の詳しい進め方は、それぞれの部の入口ページと章本文に分けて置いています。
...
Node.js / npmは、この部でWeb制作の道具として改めて確認し、未導入ならここで導入します。
...
このページは、学習ルート全体の見取り図です。
各部の具体的な章立て、確認コマンド、注意点は、それぞれの部の `index.md` と章本文で扱います。

部構成を変える場合は、まずこのシラバスを直し、次に該当する各部index、章本文、サイドバーを更新します。
